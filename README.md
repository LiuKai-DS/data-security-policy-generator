...
| 版本 | 日期 | 变更内容 |
|-----|------|---------|
| **v2.0** | 2026-04-23 | **大功能升级**：新增「📊 数据安全运营日报」模块（方案A文字/方案B文件两种模式）；新增报告脱敏规则；新增版本规范章节 |
| v1.3 | 2026-04-23 | 修正报告脱敏规则，区分公司名称（可脱敏）与人员行为信息（需保留） |
| v1.2 | 2026-04-23 | 新增行为基线四原则；新增策略评分体系（激进/平衡/保守三档） |
| v1.1 | 2026-04-23 | 内置策略库加密处理；新增示例预览文件 |
| v1.0 | 2026-04-23 | 初始版本；三阶段策略设计框架；331条行为管控策略；200条融合策略；13个部门关键字映射 |
